  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(ratingItem,index) in showRating" :key="index">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <Star :size="24" :score="ratingItem.score"/>
                <span class="delivery">{{ratingItem.deliveryTime}}天后</span>
              </div>
              <p class="text">{{ratingItem.text}}</p>
              <div class="recommend">
                <span class="iconfont icon-thumb_up"></span>
                <ul>
                  <li class="item" v-for="(recommend,index) in ratingItem.recommend" :key="index">
                    {{recommend}}
                  </li>
                </ul>
              </div>
              <div class="time">{{new Date(ratingItem.rateTime).toLocaleDateString()}}</div>
            </div>
          </li>
        </ul>
      </div>
