<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="changeSupportsShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="changeShopShow">
    ...
    <div class="shop-brief-modal" v-show="supportsShow">
      ...
      <div class="brief-modal-cover" @click="changeSupportsShow"></div>
    </div>
    <div class="activity-sheet" v-show="shopShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="changeShopShow">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
